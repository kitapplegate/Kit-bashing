...
description: 'I talked myself out of a real shrimp business and built a fake shrimp on my desktop instead. My son laughed. My girlfriend loved it.'
pubDate: 'Aug 12 2026'
---
...
ornamental shrimp, and I got obsessed. There are two big hubs people
actually buy from, not bloodlines. Surprisingly, Germany has a real
...
for the tray icon, Pillow for the images. The whole thing came together
in one sitting, eleven commits between about eleven in the morning and
7:34 that evening. Truth is, Claude did basically all of it. It'd be
driving, scrolling up the screen, and it would just say, hey, there's a
bug here.
I'd say yeah, fix it, and not think about it again. Two bugs got caught
that way. One: an early version tied his whole life to the terminal
window I started him from, so closing that killed him outright, which is
why he launches through a console-less version of Python now instead.
Two: he'd stop moving if nothing was rendering him, because the same
switch in the code controlled both drawing him and running him. Once
that got measured, drawing him cost about seven thousand times more than
moving him did, so there was never a real reason those two were tied
together.
...
everybody else's shrimp doing their thing. Tom, Dick, and Harry's
shrimp, whatever they're up to. I don't have the whole thing sketched
out yet, but that's the vision. The first piece of it already works: a
...
course you did. He's silly, I'm silly, we're all silly together. My
girlfriend's reaction was different. She just thought it was awesome.
...
I know it's a little sad. I should be able to keep a live animal fed and
alive, and I know I wouldn't. We persevere. It could be a coping
mechanism with plants and bubbles in it. The AI part, building things,
is a hobby, and it's turning into something more than that. The shrimp
thing isn't a hobby.
